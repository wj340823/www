export default {
    anchor: [{
            id: 'JBYF',
            title: '基本用法',
            component: 'BaseDatePickerDemo',
            desc: '基本用法',
        }, {
            id: 'YEAR',
            title: '年视图',
            component: 'YearDatePickerDemo',
            desc: '选择年',
        }, {
            id: 'MONTH',
            title: '月视图',
            component: 'MonthDatePickerDemo',
            desc: '选择月',
        }],
    api: {
        props: [{
                attr: 'type',
                desc: '显示类型，可选值为 date、daterange、datetime、datetimerange、year、month',
                type: 'String',
                default: 'date'
            }, {
                attr: 'format',
                desc: '展示的日期格式',
                type: 'Date',
                default: 'date | daterange：yyyy-MM-dd'
            }, {
                attr: 'placement',
